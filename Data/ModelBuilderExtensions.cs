...
namespace Backend.Data
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            var hashonecreations1 = new User { Id = "hashonecreations1@gmail.com", Email = "hashonecreations1@gmail.com", NormalizedEmail = "hashonecreations1@gmail.com", UserName = "hashonecreations1", NormalizedUserName = "hashonecreations1", EmailConfirmed = true, SecurityStamp = Guid.NewGuid().ToString() };
            modelBuilder.Entity<User>().HasData(
                adminOmair, adminUbaid, customerSome
            );
            modelBuilder.Entity<IdentityUserRole<string>>().HasData(
                ...
                new IdentityUserRole<string> { RoleId = adminRole.Id, UserId = hashonecreations1.Id }
            );
        }
    }
}