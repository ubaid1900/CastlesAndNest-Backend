...
namespace Backend.Data
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            var adminHashone = new User { Id = "hashonecreations1@gmail.com", Email = "hashonecreations1@gmail.com", NormalizedEmail = "hashonecreations1@gmail.com", UserName = "mujahidkhan17", NormalizedUserName = "mujahidkhan17", EmailConfirmed = true, SecurityStamp = Guid.NewGuid().ToString() };
            ...
            modelBuilder.Entity<User>().HasData(
                adminOmair, adminHashone, adminUbaid, customerSome
            );
